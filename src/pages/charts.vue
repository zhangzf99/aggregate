...
export default {
  ...
  methods: {
    ...
    //         },
    //         data: [22, 21, 22, 22, 19, 19, 20, 20, 21, 22, 19, 18]
    //       },
    //       {
    //         name: '休息',
    //         type: 'bar',
    ...
    drawCalendar(){
      ...
      function getVirtulData(year) {
        ...
        // console.log(date,end,dayTime,'-=-=-=')

        // var a = new Date(parseInt(end) * 1000).toLocaleString().replace(/[\\]?([a-zA-Z])/g,' ')
        // alert(a)
      ...
      function renderItem(params, api) {
        ...
        // console.log(cellPoint, cellWidth, cellHeight)
        // 图标编号  1|2
      ...
      var option = {
        ...
        series: [{
          ...
          data: [["2020-04-01","1"],["2020-04-02","1|2"],["2020-04-03","1"],["2020-04-04","1"],["2020-04-05","1"],["2020-04-06","1"],["2020-04-07","1"],["2020-04-08","2"],["2020-04-09","1"],["2020-04-10","3"]]
        }]
      };
      myChart.setOption(option)
    }
